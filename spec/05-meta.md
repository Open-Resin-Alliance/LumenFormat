...
it under `pwm.range` ([§11.2](17-validation.md#112-semantic-validation)). The range is
...
one ([§8](14-layer-timing.md#8-per-layer-settings-model)). When `material_index` is present
