...
| Reference | Topic |
|-----------|-------|
| [`DragonFruit/docs/dev/voxl-format-spec.md`](https://github.com/Open-Resin-Alliance/DragonFruit/blob/main/docs/dev/voxl-format-spec.md) | VOXL native scene container specification (embedded via VOXL chunk, [§4.12](07-scene-chunks.md#412-voxl---embedded-scene-chunk)) |
