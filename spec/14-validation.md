...
- [ ] If `ENCRYPTED` flag set, `HDR`, `AUTH` and `LTBL` do **not** have the encrypted flag set, and a `LAYR` chunk's 4-byte version field is plaintext inside its sealed chunk ([§9.1](12-encryption.md#91-design-principles)).
